...
This repository documents the intersection of **solar geometry, archaeoastronomy, and symbolic
mathematics** of the Maya and Inca civilizations. It frames ancient architectural precision
(pyramid alignments, polygonal wall tolerances, azimuth calculations) as formalized geometric
systems — and synthesizes them through the **RAFAELIA** analytical framework.
...
│
├── docs/
│   ├── espiritual-matematica-viva.md      Maya × Inca calendar diff + azimuth formulas
│   ├── incas.md                           Solar geometry & precessional corrections
│   └── piramide-serpente-alada-quetzalcoatl.md  EM resonance of Teotihuacán tunnel layers
│
├── .github/
...
```bibtex
@misc{geometriasolar2025,
  author    = {Rafael Melo Reis Novo},
  title     = {{GEOMETRIA\_SOLAR}: Maya and Inca Solar Geometry through the RAFAELIA Framework},
  year      = {2025},
  publisher = {GitHub},
  url       = {https://github.com/rafaelmeloreisnovo/GEOMETRIA_SOLAR_Maia_Inca}
}
```
